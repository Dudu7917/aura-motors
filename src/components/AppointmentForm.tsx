      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl overflow-hidden rounded-3xl bg-zinc-900 border border-white/5 shadow-2xl transition-all duration-300"
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 rounded-full bg-zinc-950/40 p-2 text-zinc-400 hover:text-white border border-white/5 transition-all cursor-pointer z-10"
            >
              <X className="h-4 w-4" />
            </button>
