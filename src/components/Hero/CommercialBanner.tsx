...
const commercials = [
  { text: "ARGUMENTO DO MÊS: TAXAS DE FINANCIAMENTO A PARTIR DE 0.99% A.M. NOS BANCOS PARCEIROS!", tag: "DICA DE VENDA" },
  { text: "ESTOQUE 100% PERICIADO COM LAUDO CERTIFICADO PARA APRESENTAR NA MESA DE NEGOCIAÇÃO!", tag: "ARGUMENTO FORTE" },
  { text: "FOTOS REAIS E FICHAS TÉCNICAS ATUALIZADAS PARA ENVIAR AOS CLIENTES PELO WHATSAPP!", tag: "CONVERSÃO" }
];
