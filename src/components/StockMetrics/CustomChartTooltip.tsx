...
export const CustomChartTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="rounded-2xl border border-amber-500/30 bg-zinc-950/95 p-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.8)] backdrop-blur-xl font-mono text-xs z-50">
        ...
        {data.payload?.percentage && (
          <p className="text-amber-400 text-[10px] font-bold mt-1">
